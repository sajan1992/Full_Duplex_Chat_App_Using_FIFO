...
int main()
{
	...
	{	
		while(1)
		{
		if(read(ret2,msg2,100))
		{
		printf("\e[44mRecieved: \e[0m %s \n",msg2);
		if(!(strncmp(msg2,"exit",4)))
		{	
			printf("\e[41mExit command Initiated!\e[0m\n");
